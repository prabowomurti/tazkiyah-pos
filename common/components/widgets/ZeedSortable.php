...
class ZeedSortable extends Sortable
{
    ...
    public function run()
    {
        ...
        echo '<thead><tr><th style="border-bottom: none !important">ID</th><th style="border-bottom: none !important">Label</th></tr></thead>' . "\n";
    ...
    public function renderItems()
    {
        ...
        foreach ($this->items as $item) {
            $tag = 'tr';
            $items[] = Html::tag($tag, $item['content'], ['style' => 'cursor:pointer', 'id' => 'position_' . $item['id']]);
        }
